...
void Pacman::draw(bool i_victory, sf::RenderWindow& i_window)
{
	...
	if (1 == dead || 1 == i_victory)
	{
		if (animation_timer < PACMAN_DEATH_FRAMES * PACMAN_ANIMATION_SPEED)
		{
			...
			texture.loadFromFile("/Users/maxencegama/Desktop/Programmation/Coding\ in\ C\:C++/pacman/pacman/Resources/Images/PacmanDeath" + std::to_string(CELL_SIZE) + ".png");
	...
	{
		texture.loadFromFile("/Users/maxencegama/Desktop/Programmation/Coding\ in\ C\:C++/pacman/pacman/Resources/Images/Pacman" + std::to_string(CELL_SIZE) + ".png");
